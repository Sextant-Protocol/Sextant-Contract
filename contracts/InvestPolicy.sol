...
contract InvestPolicy is IInvestPolicy, Ownable {
    using SafeERC20 for IERC20;

    address[] defis; //可投资DeFi合约白名单
    IERC20[] tokens; //可持仓/兑换币种
    IERC20 localToken; //基金募集token
    IOracle public oracle;
    IInvestPolicyTemplate public investPolicyTemplate;
    string detail;
    mapping(address => bool) isValidDefis;
